...
//    [self.httpServer setInterface:IP_LOCALHOST];
//  }
//
...
- (void)startServer:(CDVInvokedUrlCommand*)command
{
  ...
  [DDLog addLogger:[DDTTYLogger sharedInstance]];
  self.httpServer = [[CLHTTPServer alloc] init];
  ...
  NSLog(@"Setting document root: %@", mediaPath);
  [self.httpServer setDocumentRoot:mediaPath];
